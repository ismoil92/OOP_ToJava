...
public class Notebook extends Computer implements ComputerInterface, Comparator<Computer> {

    public Notebook(){

    }

    public Notebook(int id, int ram, int hardware, String operSys, String color){
        super.id=id;
        super.ram=ram;
