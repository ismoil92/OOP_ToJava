import Lesson3.HotDrink;
import Lesson3.HotDrinkVendingMachine;
import Lesson3.VendingMachine;
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println("===========================================================");
        while(((HotDrinkVendingMachine) hotdrinkmachine).hasNext()){
            System.out.println(((HotDrinkVendingMachine) hotdrinkmachine).next());
        }
    }
}